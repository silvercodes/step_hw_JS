 ...
 */
function init() {
    document.getElementById('btnNewList').addEventListener('click', addList, false);
    document.getElementById('btnAddEntry').addEventListener('click', addEntry, false);
    document.getElementById('btnClearAll').addEventListener('click', clearList, false);
    document.getElementById('btnDeleteList').addEventListener('click', deleteList, false);
    document.getElementById('btnRemoveCompleted').addEventListener('click', removeCompleted, false);
    document.getElementById('btnSave').addEventListener('click', saveToLocalStorage, false);
